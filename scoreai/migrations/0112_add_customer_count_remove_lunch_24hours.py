# Generated by Django 5.1.2 on 2026-01-10 13:07
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('scoreai', '0111_add_24hours_and_28hour_support'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.IntegerField(default=0, help_text='1日あたりの客数。24時間営業の場合は合計客数を入力', verbose_name='夜の客数（人/日）'),
        ),
        migrations.AddField(
            model_name='izakayaplan',
            name='lunch_customer_count',
            field=models.IntegerField(default=0, help_text='1日あたりの客数', verbose_name='昼の客数（人/日）'),
        ),
