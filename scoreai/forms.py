...
class FirmRegistrationForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super(FirmRegistrationForm, self).__init__(*args, **kwargs)
        self.fields['entity_type'].required = True
        self.fields['name'].required = True
...
class FirmCompanyRegistrationForm(forms.ModelForm):
    """Firm配下のCompany登録フォーム（簡易版）"""
    class Meta:
        model = Company
        fields = [
            'name', 'fiscal_month', 'industry_classification', 
            'industry_subclassification', 'company_size'
        ]
        widgets = {
            'name': forms.TextInput(attrs={'class': 'form-control'}),
            'fiscal_month': forms.NumberInput(attrs={
    ...
    def __init__(self, *args, **kwargs):
        super(FirmCompanyRegistrationForm, self).__init__(*args, **kwargs)
        self.fields['name'].required = True
        self.fields['fiscal_month'].required = True
        self.fields['industry_classification'].required = True
        self.fields['industry_subclassification'].required = True
